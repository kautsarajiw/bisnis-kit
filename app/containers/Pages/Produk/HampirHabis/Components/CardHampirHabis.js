...
import messages from 'enl-components/CardPaper/messages';
    ...
    return (
      <Card className={classNames(classes.cardProduct, isWidthUp('sm', width) && list ? classes.cardList : '')}>
        ...
        <CardContent className={classes.floatingButtonWrap}>
          {!soldout && (
            <>
              <Tooltip title={'Sunting Stok Produk'} placement="top">
                <Fab onClick={addToCart} size="small" color="primary" aria-label="add" className={classes.buttonAdd} style={{backgroundColor:'#34495e'}}>
                  <CreateOutlined />
                </Fab>
              </Tooltip>
            </>
