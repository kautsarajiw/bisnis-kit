...
//import component
import ListSemuaProduk from './Components/ListSemuaProduk'

class SemuaProduk extends React.Component {
  state = {
    listView: 'grid',
  }
...
const SemuaProdukMapped = connect(
  mapStateToProps,
  constDispatchToProps
)(SemuaProduk);

export default SemuaProdukMapped;
